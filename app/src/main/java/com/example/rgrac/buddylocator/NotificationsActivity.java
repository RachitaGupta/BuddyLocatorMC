    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        obj.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                alertDialogBuilder.setMessage("Doc you want to give location access to "+message);
                alertDialogBuilder.setPositiveButton("yes",new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface arg0, int arg1) {
                        String accept="2";
                        PasswordChange passchange = new PasswordChange(getApplicationContext(),status);
                        passchange.execute(message,user,accept);
...
class Notification extends AsyncTask<String, Void,String> {
    ...
    protected String doInBackground(String... arg0) {
        ...
        try {
            username = arg0[0];
            String getnotif= "http://192.168.0.12/buddylocator/getNotification.php";
