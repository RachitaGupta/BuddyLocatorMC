...
/**
 * Created by rgrac on 11/18/2016.
 */
public class PasswordChange extends AsyncTask<String,Void,String> {
    ...
    public PasswordChange(Context context,String status) {
    ...
    protected String doInBackground(String... arg0) {
        ...
        try {
            urlrequest= new URL("http://192.168.0.12/buddylocator/requestupdate.php");
        ...
        try {
            ...
            Uri.Builder builder = new Uri.Builder().appendQueryParameter("username", arg0[0])
                    .appendQueryParameter("friendusername", arg0[1])
